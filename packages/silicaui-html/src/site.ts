 ...
 * site's shared theme + the site's shell. This is the unit `toHtml` renders, and
 ...
 * the site's frame (the frame's single Outlet is replaced by the body). A site
 * with no frame renders its pages bare. This is the production markup a visitor
 * to that route receives. Returns undefined for an unknown page id.
 */
