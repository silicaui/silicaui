...
- 9accc71: Both theme tools now say who EMITS a preset, instead of half an instruction that fails silently
  ...
  **`tokensNote` was rewritten.** It said _"do not paste these values into CSS"_, which forbids
...
- 9949471: The catalog publishes the email host contract, which it never had at all
